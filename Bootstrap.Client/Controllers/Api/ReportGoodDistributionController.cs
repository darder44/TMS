...
namespace Bootstrap.Client.Controllers.Api
{
    ...
    [ApiController]
    public class ReportGoodDistributionController : ControllerBase
    {   
        ///<summary>
        ///
        ///</summary>
        [HttpGet]
        public QueryData<object> Get([FromQuery] QueryReportGoodDistributionOption value)
        {
        ...
        public string ExportExcel([FromServices]IMemoryCache cache, [FromBody]ExportExcelBody<QueryReportGoodDistributionOption> value)
        {
            ...
            var param = new NpoiParam<ReportGoodDistribution>
            {                
                Data = data,                              //資料               
            ...
            List<NpoiParam<ReportGoodDistribution>> list = new List<NpoiParam<ReportGoodDistribution>>(){ param };
