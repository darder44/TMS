...
namespace Bootstrap.Client.Controllers.Api
{
    ...
    [ApiController]
    public class ReportRouteListController : ControllerBase
    {   
        ///<summary>
        ///
        ///</summary>
        [HttpGet]
        public QueryData<object> Get([FromQuery] QueryReportRouteListOption value)
        {
        ...
        public string ExportExcel([FromServices]IMemoryCache cache, [FromBody]ExportExcelBody<QueryReportRouteListOption> value)
        {
            ...
            var param = new NpoiParam<ReportRouteList>
            {                
                Data = data,                              //資料               
            ...
            List<NpoiParam<ReportRouteList>> list = new List<NpoiParam<ReportRouteList>>(){ param };
